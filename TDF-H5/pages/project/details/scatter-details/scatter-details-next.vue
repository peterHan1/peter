    ...
    <div class="top_nav">
      <ul>
        <li 
          :class="{on: active[0]}" 
          i="0" 
          @click="tabs(0)">项目介绍</li>
        <li 
          :class="{on: active[1]}" 
          i="1" 
          @click="tabs(1)">透明合规</li>
        <li 
          :class="{on: active[2]}" 
          i="2" 
          @click="tabs(2)">出借记录</li>
      </ul>
    </div>
      ...
      <div class="content">
        <div 
          ...
          <div class="store_info">
            ...
            <p class="name"><i/>门店名称: <span>嘉兴桐乡店</span></p>
            <p class="addr"><i/>地址: <span>浙江省嘉兴市桐乡市银菊路6-10号</span></p>
            <p class="call"><i/>联系电话: <a href="tel:400-85-666-85">400-85-666-85</a></p>
          </div>
        </div>
        <div 
          v-else-if="active[1]" 
        ...
        <div 
          ...
          <ul 
            ...
            <li 
              ...
              :key="index">
              <p class="phone">{{ item.phone }}&nbsp;<span :class="[index === 0?'most':'', index === 1?'less':'', index === 2?'first':'']"/></p>
              <dl class="info">
                <dt>{{ item.money }}</dt>
                <dd>{{ item.time }}</dd>
              </dl>
  ...
  .scatter
    ...
    .content
      .scatter_item
        width:100%
        background-color: #fff
        .loan_info .info_details
          width:100%
          border-bottom:.2rem solid #F2F3F7
          p
            height:.37rem
            font-size:.26rem
            padding: 0 .3rem
        ...
        .item_overview
          ...
          .overview_info
            ...
            height:6.14rem
            padding-top: .25rem
            border-bottom:.20rem solid #F2F3F7
            .ts
        ...
        .store_info
          ...
          .name
            ...
            i
              ...
              width:.3rem
              height:.3rem
              background: url(../../../../assets/images/invest/name.png) no-repeat center
              background-size: 100%
              vertical-align: middle
              margin-right:.2rem
          .addr
            ...
            i
              ...
              width:.26rem
              height:.3rem
              background: url(../../../../assets/images/invest/addr.png) no-repeat center
              background-size: 100%
              vertical-align: middle
              margin-right:.2rem
            span
          ...
          .call
            ...
            i
              ...
              width:.26rem
              height:.3rem
              background: url(../../../../assets/images/invest/phone.png) no-repeat center
              background-size: 100%
              vertical-align: middle
              margin-right:.2rem
            a
              color:#FF7102
        .safeguard_step .step_info
          height:3.42rem
          padding: .24rem .51rem .07rem .31rem
          font-size:.26rem
          color:#333333
          border-bottom:.2rem solid #F2F3F7
          p
            line-height:.4rem
        .money_mange .mange_info
          height:2.17rem
          padding: .24rem .51rem .21rem .31rem
          font-size:.26rem
          color:#333333
        .borrow_record
          margin-bottom: 1rem
