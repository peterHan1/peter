<template>
  <div class="protocalTop">
    ...
    <p>2.出借人自愿使用“拓道金服”网络借贷平台上发布的 “省心投” 自动投标工具（以下简称“省心投”）。</p>
    ...
    <p>2.加入及授权出借金额：共计人民币元  （大写:）。</p>
    <p>3.本人知晓并确认通过该工具预计匹配到的标的期限为 月，同类型项目历史参考约定利率为%，出借标的类型为抵押或质押标（以最终匹配到的标的为准）。</p>
    ...
    <b>本授权委托书经出借人自行通过网络在“拓道金服”网络借贷平台上在线点击相关确认键后生效。</b>
    <p>委托人：</p>
