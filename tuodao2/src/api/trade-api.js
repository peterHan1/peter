...
var _trade = {
	...
	bankList: function(headerData,resolve, reject) {
		_td.request({
			method: 'post',
			url: '/api/router/recharge/bankList',
	...
	cash :  function(headerData,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/tc/account/to_cash',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			success : resolve,
			error   : reject
	...
	cashApply: function(headerData,data, resolve, reject) {
		_td.request({
			method: 'post',
			url: '/api/router/tc/account/cash_apply',
			data: data,
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			success: resolve,
	...
	cashList: function(headerData,pagenum, pagesize, resolve, reject) {
		_td.request({
			method: 'post',
			url: '/api/router/tc/account/cash_list',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			data: {
				currentPage:pagenum,
	...
	cashFee :  function(headerData,cashMoney,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/tc/account/cash_fee',
			data    : {
				cashMoney:cashMoney
			},
			accessId:headerData.accessId,
	...
	rechargeInfo :  function(headerData,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/recharge/rechargeInfo',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			success : resolve,
			error   : reject
	...
	rechargeOnline :  function(headerData,data,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/recharge/online',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			data    : data,
			success : resolve,
	...
	sendSmsCode :  function(headerData,money,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/recharge/sendSmsCode',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			data    : {
				money: money
	...
	fastPay :  function(headerData,data,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/recharge/fast/pay',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			data    : data,
			success : resolve,
	...
	moneyRecord :  function(headerData,data,resolve,reject){
		_td.request({
			method	: 'post',
			url     : '/api/router/tc/account/account_log_list',
			accessId:headerData.accessId,
			accessKey:headerData.accessKey,
			data: data,
			success : resolve,
	...
	getSiftPhone : function(id,pagesize,pagenum,resolve, reject){
		_td.request({
			url  : '/api/router/joinPlanController/getJoinPlanList',
			data : {
				borrowId	: id,
				pageSize 	: pagesize,
				currentPage : pagenum
	...
	getScatterPhone : function(id,pagesize,pagenum,resolve, reject){
		_td.request({
			url     : '/api/router/tc/product/tender_list',
			data    : {
				productId	: id,
				pageSize 	: pagesize,
				currentPage : pagenum
	...
	getScatterFinis : function(id,resolve, reject){
		_td.request({
			url     : '/api/router/tc/product/tender_max_last',
			data    : {
				productId	: id
			},
			success : resolve,
	...
	getSiftFinis : function(id,resolve, reject){
		_td.request({
			url     : '/api/router/joinPlanController/getMaxAndPic',
			data    : {
				borrowId	: id
			},
			success : resolve,
	...
	getInvestListBond : function(type,pagenum,pagesize,resolve, reject){
		_td.request({
			url     : '/api/router/creditAssignment/query',
			data    : {
				type		: type,
				currentPage : pagenum,
				pageSize 	: pagesize
	...
	getInvestBondDetails : function(id,resolve, reject){
		_td.request({
			url     : '/api/router/creditAssignment/query/info',
			data    : {
				transferId	: id
			},
			asyncType: false,
	...
	// 债权转让详情 投资列表
	getInvestPhone : function(id,pagesize,pagenum,resolve, reject){
		_td.request({
			url     : '/api/router/tender/transfer/list',
			data    : {
				transferId	: id,
				pageSize 	: pagesize,
				currentPage : pagenum
	...
	getInvestUc : function(headerData,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/user/account/get_account',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			success 	: resolve,
			error   	: reject
	...
	subInvestSift : function(headerData,params,resolve, reject){
		_td.request({
			url     	: '/api/router/joinPlanController/joinPlan',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: params,
			success 	: resolve,
	...
	subInvestScatter : function(headerData,params,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/add_tender',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: params,
			success 	: resolve,
	...
	subInvestScatterResult : function(headerData,params,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/tender_result',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: params,
			success 	: resolve,
	...
	subInvestBond : function(headerData,params,resolve, reject){
		_td.request({
			url     	: '/api/router/creditAssignment/tender',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: params,
			success 	: resolve,
	...
	getsumMoney : function(headerData,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/total_collection',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			success 	: resolve,
			error   	: reject
	...
	getMonthMoney : function(headerData,month,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/pre_month_collection',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				month	: month
	...
	getMoneys : function(headerData,day,type,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/month_collection',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				day		: day,
	...
	getMonth : function(headerData,month,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/collection_days',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: {
				month 	: month
	...
	getRturnList : function(headerData,day,type,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/collection_calendar_list',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    : {
				day			: day,
	...
	getSift : function(headerData,sta,startime,endtime,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/joinPlanController/getTenderByUserId',
			accessId	:headerData.accessId,
			accessKey	:headerData.accessKey,
			data    	: {
				status 		: sta 		|| "",
	...
	getSiftDel : function(headerData,id,resolve, reject){
		_td.request({
			url     	: '/api/router/joinPlanController/selectTenderById',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				justId 	: id
	...
	getSiftCred : function(headerData,id,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/joinPlanController/selectTenderListByChoicenessTenderId',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				justId 		: id,
	...
	getSiftReturn: function(headerData,id,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/joinPlanController/selectRecoverListBychioId',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				justId 	: id,
	...
	getScstter : function(headerData,sta,startime,endtime,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/tender_list',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				status 		: sta 		|| "",
	...
	getScstterDet : function(headerData,id,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/tender_detail',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				tenderId 	: id
	...
	getBond : function(headerData,sta,startime,endtime,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/creditAssignment/list',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				status 		: sta,
	...
	getBondyet : function(headerData,sta,startime,endtime,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/creditAssignment/compromisedList',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				status 		: sta,
	...
	getApply : function(headerData,id,resolve,reject){
		_td.request({
			url     	: '/api/router/creditAssignment/preApply',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				tenderId 	: id
	...
	subApply : function(headerData,id,pasw,resolve,reject){
		_td.request({
			url     	: '/api/router/creditAssignment/apply',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				tenderId 	: id,
	...
	getBondTop : function(headerData,id,resolve, reject){
		_td.request({
			url     	: '/api/router/creditAssignment/tender/product/info',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				tenderId : id
	...
	getBondRet : function(headerData,id,pagesize,current,resolve, reject){
		_td.request({
			url     	: '/api/router/creditAssignment/tender/repayment/plan',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    	: {
				tenderId : id,
	...
	getAutoBank : function(headerData,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/check_bank',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			success 	: resolve,
			error   	: reject
	...
	getInpForm: function(headerData,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/get_auto_tender',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			success 	: resolve,
			error   	: reject
	...
	openAuto : function(headerData,param,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/add_auto_tender',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: param,
			success 	: resolve,
	...
	closeAuto : function(headerData,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/close_auto_tender',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			success 	: resolve,
			error   	: reject
	...
	autoLists : function(headerData,pageSize,currentPage,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/auto_tender_list',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    : {
				pageSize: pageSize,
	...
	getAutoTop : function(headerData,id,resolve, reject){
		_td.request({
			url     	: '/api/router/tc/tender/auto_tender_detail',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data    : {
				autoTenderId: id
	...
	getAutoList : function(headerData,id,pagesize,current,resolve,reject){
		_td.request({
			url 		: '/api/router/tc/tender/sub_auto_tender_list',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: {
				autoTenderId : id,
	...
	// 精选计划委托书
	sift_protocol : function(headerData,id,resolve,reject){
		_td.request({
			url     	: '/api/router/joinPlanController/getPlanProtocol',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: {
				tenderId : id
	...
	// 散标项目借款协议
	scatter_protocol : function(headerData,id,resolve,reject){
		_td.request({
			url     	: '/api/router/tc/tender/borrow_protocol',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: {
				tenderId : id
	...
	// 债权转让协议
	bond_protocol : function(headerData,id,resolve,reject){
		_td.request({
			url     	: '/api/router/creditAssignment/protocol',
			accessId	: headerData.accessId,
			accessKey	: headerData.accessKey,
			data 		: {
				tenderId : id
