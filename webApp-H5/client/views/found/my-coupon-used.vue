<template>
  <div class="max_width myCouponUsed">
    <Header navLeftTxt="icon">已使用优惠券</Header>
    <ul class="header">
      ...
      <ul class="jxq" v-if="state">
        <li v-for="item in jxq">
          ...
          <div class="fl right">
            <p>{{item.source}}</p>
            <p>有效期：{{item.time}}</p>
            <img src="../../assets/images/found/used.png" alt="">
          </div>
        </li>
      </ul>
      <ul class="dyq" v-else>
    ...
    .dyq,.jxq
      ...
      li
        ...
        .left
          ...
          text-align: center
          background: url(../../assets/images/found/coupon3.png)center no-repeat
          background-size: 100%
          color: #fff
          p:first-child
            font-size: 0.3rem
