<template>
  <div class="resultBox">
    <Header :navLeftTxt="'icon'">充值结果</Header>
		<!-- xw_load xw_ok-->
    <div class="result xw_no">
			<div class="xw_icon resultNo"></div>
			<div class="xw_txt">充值成功！</div>
			<div class="xw_msg">返回充值失败原因</div>
			<div class="xw_btn">
				<!-- <router-link to="/">返回</router-link> -->
				<!-- <router-link to="/">继续充值</router-link> -->
				<!-- <router-link to="/">查看充值记录</router-link> -->
				<router-link to="/">更换银行卡</router-link>
