    ...
    <drop-move :load-bottom="loadBottom">
      <div class="details">
        <div class="money">
          ...
          <div class="progress">
            <transition appear v-on:before-appear="beforeAppear" v-on:appear="appear" v-on:after-appear="afterAppear">
        ...
        <div class="content">
          <ul class="explain">
            ...
            <li><span>计息方式</span><span>满标复审后计息</span></li>
            <li><span>募集期限</span><span>1-15个工作日</span></li>
          </ul>
          <div class="count">
            <div class="top"><span></span>&nbsp;收益计算器</div>
            <div class="con">
              <div class="title">
                <p>出借&nbsp;(元)</p>
                <p>{{corpus}}</p>
            ...
            <div class="bottom">
              ...
              <ul>
                <li class="flex-1" :class="{on: active[0]}" @click="select(0)"><span></span>&nbsp;无加息</li>
                <li class="flex-1" :class="{on: active[1]}" @click="select(1)"><span></span>&nbsp;1%加息</li>
                <li class="flex-1" :class="{on: active[2]}" @click="select(2)"><span></span>&nbsp;2%加息</li>
                <li class="flex-1" :class="{on: active[3]}" @click="select(3)"><span></span>&nbsp;3%加息</li>
              </ul>
            </div>
          </div>
        </div>
...
<script>
  export default {
    ...
    methods: {
      loadBottom () {
        this.$router.push('/scatterDetailsNext')
      },
      select (type) {
        if (type === 0) {
