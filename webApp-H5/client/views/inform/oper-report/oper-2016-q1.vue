<template>
  <div class="jd-1-16">
    ...
    <div class="jd-1-bg4"></div>
    <div class="jd-1-bg5"></div>
    <div class="jd-1-bg6"></div>
    <div class="jd-1-bg7"></div>
    <div class="jd-1-bg8"></div>
    <div class="jd-1-bg9"></div>
    <div class="jd-1-bg10"></div>
    <div class="jd-1-bg11"></div>
  </div>
</template>
<script>
export default {
