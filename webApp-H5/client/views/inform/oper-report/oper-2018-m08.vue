<template>
  <div class="month-8">
    <Header navLeftTxt="icon">拓道金服<span>2018</span>年度<span>8</span>月份运营报告</Header>
    <div class="month-8-banner"></div>
    <div class="month-8-bg1"></div>
    <div class="month-8-bg2"></div>
    <div class="month-8-bg3"></div>
    <div class="month-8-bg4"></div>
    <div class="month-8-bg5"></div>
    <div class="month-8-bg6"></div>
    <div class="month-8-bg7"></div>
    <div class="inform-charge"></div>
    <div class="month-8-bg8"></div>
  </div>
</template>
<script>
export default {
