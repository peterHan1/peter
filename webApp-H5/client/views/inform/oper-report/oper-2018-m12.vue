<template>
  <div class="month-12">
    <Header navLeftTxt="icon">拓道金服<span>2018</span>年度<span>12</span>月份运营报告</Header>
    <div class="month-12-banner"></div>
    <div class="month-12-bg1"></div>
    <div class="month-12-bg2"></div>
    <div class="month-12-bg3"></div>
    <div class="month-12-bg4"></div>
    <div class="month-12-bg5"></div>
    <div class="month-12-bg6"></div>
    <div class="month-12-bg7"></div>
    <div class="compliance-bg"></div>
    <div class="inform-charge"></div>
    <div class="month-12-bg8"></div>
  </div>
</template>
<script>
export default {
