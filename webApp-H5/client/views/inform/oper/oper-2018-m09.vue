<template>
  <div class="month-9">
    ...
    <div class="month-9-bg3"></div>
    <div class="month-9-bg4"></div>
    <div class="month-9-bg5"></div>
    <div class="month-9-bg6"></div>
    <div class="month-9-bg7"></div>
    <div class="month-9-bg8"></div>
    <div class="month-9-bg9"></div>
    <div class="month-9-bg10"></div>
    <div class="inform-charge"></div>
    <div class="month-9-bg11"></div>
  </div>
</template>
<script>
export default {
