export const appRouter = [
  ...
  },
  {
    path: '/orderDetails',
    name: 'orderDetails',
    component: () => import('@/views/home/orderDetails.vue'),
    meta: { title: '我的订单', keepAlive: true, auth: true }
  },
  {
    path: '/coupons',
    name: 'coupons',
    component: () => import('@/views/home/coupons.vue'),
    meta: { title: '优惠券', keepAlive: true, auth: true }
  },
  {
    path: '/help',
    name: 'help',
    component: () => import('@/views/home/help.vue'),
    meta: { title: '常见问题', keepAlive: true, auth: true }
  },
  {
    path: '/auth',
    name: 'auth',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'borrowPay',
        name: 'borrowPay',
        component: () => import('@/views/payment/borrowPay.vue'),
        meta: {title: '借支付', keepAlive: true, auth: true}
      },
      {
        path: 'payNow',
        name: 'payNow',
        component: () => import('@/views/payment/payNow.vue'),
        meta: {title: '借支付', keepAlive: true, auth: true}
      },
      {
        path: 'detail',
        ...
        meta: {title: '使用详情', keepAlive: true, auth: true}
      },
      {
        path: 'details',
        name: 'details',
        component: () => import('@/views/payment/details.vue'),
        meta: {title: '更换套餐使用详情', keepAlive: true, auth: true}
      }
    ]
  }
]
