window.ShearPhoto.MINGGE(function() {
	...
	Shear.config({
		...
		/*HTML5重点功能*/
		HTML5FilesSize: 2, //如果是HTML5切图时，选择的图片不能超过多少，单位M，,你设大点都不怕，        ------因为HTML5ZIP会对原图进行压缩处理
		...
		scopeWidth: 200, //可拖动范围宽  也就是"main"对象的初始大小(整数型，禁止含小数点) 宽和高的值最好能一致  

		scopeHeight: 200, //可拖动范围高  也就是"main"对象的初始大小(整数型，禁止含小数点) 宽和高的值最好能一致      
